...
public class SignInEmailPasswordActivity extends AppCompatActivity {
    ...
    private static final String TAG = SignInEmailPasswordActivity.class.getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                signinWithEmailAndPassword(usernameEditText.getText().toString(),
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SignInEmailPasswordActivity.this, "Authentication failed : " + task.getException().getMessage(),
    ...
    public void register(View view) {
        startActivity(new Intent(getApplicationContext(), RegisterEmailPasswordActivity.class));
    }
